...
"""
Loading and simulating robot files
"""
...
class RobotModelLink(_object):
    ...
    def getMesh(self):
        """
        getMesh(RobotModelLink self) -> TriangleMesh

        TriangleMesh
        RobotModelLink::getMesh() 
        """
        return _robotsim.RobotModelLink_getMesh(self)

    def setMesh(self, *args):
        """
        setMesh(RobotModelLink self, TriangleMesh mesh)

        void
        RobotModelLink::setMesh(const TriangleMesh &mesh) 
        """
        return _robotsim.RobotModelLink_setMesh(self, *args)
...
class RigidObjectModel(_object):
    ...
    def getMesh(self):
        """
        getMesh(RigidObjectModel self) -> TriangleMesh

        TriangleMesh
        RigidObjectModel::getMesh() 
        """
        return _robotsim.RigidObjectModel_getMesh(self)

    def setMesh(self, *args):
        """
        setMesh(RigidObjectModel self, TriangleMesh mesh)

        void
        RigidObjectModel::setMesh(const TriangleMesh &mesh) 
        """
        return _robotsim.RigidObjectModel_setMesh(self, *args)
...
class TerrainModel(_object):
    ...
    def getMesh(self):
        """
        getMesh(TerrainModel self) -> TriangleMesh

        TriangleMesh
        TerrainModel::getMesh() 
        """
        return _robotsim.TerrainModel_getMesh(self)

    def setMesh(self, *args):
        """
        setMesh(TerrainModel self, TriangleMesh mesh)

        void
        TerrainModel::setMesh(const TriangleMesh &mesh) 
        """
        return _robotsim.TerrainModel_setMesh(self, *args)
...
class SimBody(_object):
    ...
    __swig_setmethods__["mesh"] = _robotsim.SimBody_mesh_set
    __swig_getmethods__["mesh"] = _robotsim.SimBody_mesh_get
    if _newclass:mesh = _swig_property(_robotsim.SimBody_mesh_get, _robotsim.SimBody_mesh_set)
